...
rate = rospy.Rate(10)
setpoint = Setpoint(sonar_readings=[500,500,500,500,500,500])

raw_input("Press any key to begin")


#setpoint.altitude_change(5)
#print("Altitude up")
setpoint.pitch(10, wait=True, check_obs=False, sonar_readings=[500,500,500,500,500], store_final = True)
print "Arrived"
