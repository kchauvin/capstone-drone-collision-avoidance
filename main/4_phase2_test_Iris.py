...
front_threshold = 320
front_threshold_delta = 100


#test up
usonic = usonic(0x70, 5, disable_mask = [False, True, True, True, True, True], sim_readings=[-1,100,600,100,600,600], threshold=[front_threshold,500,500,500,500])
#test to left
...
def nav_decision(obs_present):
    #object to the right
    if obs_present[1] and not(obs_present[3]):
        print "Rolling left"
    ...
    # object to the left
    elif obs_present[3] and not(obs_present[1]):
        print "Rolling right"
