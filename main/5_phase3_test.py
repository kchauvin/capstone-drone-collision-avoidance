...
def nav_decision(obs_present, no_object_bottom_row, no_object_mid_row, no_object_top_row, no_object_left_column, no_object_mid_column, no_object_right_column):
    ...
    print obs_present, no_object_bottom_row, no_object_mid_row, no_object_top_row, no_object_left_column, no_object_mid_column, no_object_right_column
...
#test up
#usonic = usonic(0x70, 4, disable_mask = [False, True, True, True, True, True], sim_readings=[-1,100,600,100,600,600], threshold=[front_threshold,500,500,500,500])
#test to left
#usonic = usonic(0x70, 4, disable_mask = [False, True, True, True, True, True], sim_readings=[-1,100,600,600,600,600], threshold=[front_threshold,500,500,500,500])
#test to right
#usonic = usonic(0x70, 4, disable_mask = [False, True, True, True, True, True], sim_readings=[-1,600,600,50,600,600], threshold=[front_threshold,500,500,500,500])
