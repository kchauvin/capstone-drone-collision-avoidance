...
while (True):
    ...
    im_with_keypoints = cv2.drawKeypoints(disparity,keypoints,np.array([]),(0.0,255),cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
    print keypoints
    ...
    cv2.imshow('Depth Map with Keypoints', im_with_keypoints)
