...
while (True):
    ...
    window_size=7
    min_disp= 16 #+16*cv2.getTrackbarPos('minDisp','Depth Map')
    num_disp = 64 #+16*cv2.getTrackbarPos('numDisp','Depth Map')
    ...
    stereo = cv2.StereoSGBM_create(
          ...
          speckleWindowSize = cv2.getTrackbarPos('SpeckleWinSize','Depth Map'),
          speckleRange = 100
    )
